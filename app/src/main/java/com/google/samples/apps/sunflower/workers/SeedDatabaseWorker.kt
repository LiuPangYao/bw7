...
class SeedDatabaseWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            val toy_3: Plant = Plant("BW7-變形金剛柯博文", "BW7-變形金剛柯博文", "變形金剛-柯博文配色,本次全新 BW-7 MR 版本,除了原有的舊化厚實質感外,也展現了帥氣的機器人造型.", 2600, 2600, "https://imgur.com/9s4luw2.png", 8,"R.drawable.bw08", 1)
            val toy_4: Plant = Plant("BW7-變形金剛大黃蜂", "BW7-變形金剛大黃蜂", "2020 TTF 會場限定版,變形金剛-大黃蜂配色", 2500, 2500, "https://imgur.com/pASuuVN.png", 6,"R.drawable.bw06", 1)
            ...
            val toy_11: Plant = Plant("BW7-螢光", "BW7-螢光", "未販售.", 2700, 2700, "https://imgur.com/nAbEfEw.png", 10, "R.drawable.bw10", 1)
